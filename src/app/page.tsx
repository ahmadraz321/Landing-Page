...
const heroSections = {
  ...
  motive: " Latest updates",
  version: "Just shipped v1.0",
  heading: "Deploy to the cloud with confidence",
  content:
    "Anim aute id magna aliqua ad ad non deserunt sunt. Qui irure qui lorem cupidatat commodo. Elit sunt amet fugiat veniam occaecat fugiat aliqua",
  gettingStartedLink: "#",
  imageSrc: "/yola-features-cover-1.png",
};

const logoCloud = {
  title: `The world’s most innovative companies use our app`,
  logos: [
      {icon: PlusCircleIcon},
      {icon: PlusCircleIcon},
      {icon: PlusCircleIcon},
...
const ctaSection = {
  ...
  heading2: "Start using our app today.",
  content:
...
const footer = {
  title: " Footer",
  companyDesc: ` 2024 Your Company, Inc. All rights reserved.`,
  footerNavigation: [
    {
      name: "Facebook",
      href: "#",
  ...
  return (
    <main>
      <Example
        ...
        logoCloud={logoCloud}
        features={features}
        everyThingsNeed={everyThingsNeed}
        stats={stats}
